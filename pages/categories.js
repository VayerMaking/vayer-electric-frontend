  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Vayer Electric - All Categories</title>
          <meta name="description" content={`Vayer Electric - All categories`} />
          <meta property="og:title" content="Vayer Electric - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
